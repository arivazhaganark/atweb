...
class PartnerReply extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($from_email, $mail_header)
                ...
                ->view('emails.partner_reply')
                ->with(['first_name' => $this->user->first_name, 'last_name' => $this->user->last_name, 'email' => $this->user->email, 'password' => $password, 'company' => $this->user->companyname]);         
    }

                    ...
                    <div class="tab-content">
                        <div id="en" class="tab-pane fade in active">
                            <form role="form" class="form-horizontal">
                                ...
                                <dl class="dl-horizontal">
                                    <dt>Designation :</dt>
                                    <dd>{{ $testimonials->designation }}</dd>
                                </dl>
                                <dl class="dl-horizontal">
                                    <dt>Email :</dt>
                                    <dd>{{ $testimonials->email }}</dd>
                                </dl>
                                <dl class="dl-horizontal">
                                    <dt>Website :</dt>
                                    <dd>{{ $testimonials->website }}</dd>
                                </dl>
                                <dl class="dl-horizontal">
                                    <dt>Location :</dt>
                                    <dd>{{ $testimonials->location }}</dd>
                                </dl>
                                <dl class="dl-horizontal">
                                    <dt>Title of Testimonial  :</dt>
                                    <dd>{{ $testimonials->testi_title }}</dd>
                                </dl> 
                                <dl class="dl-horizontal">
                                    <dt>Description :</dt>

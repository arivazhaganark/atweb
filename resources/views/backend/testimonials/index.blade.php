    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            ?>">
                ...
                @endif
                <div class="box-body">
                    <table @if($testimonials->count()>0) id="example1" @else id="" @endif class="table table-bordered table-striped">
                            <thead>
                            <tr class="bg-gray color-palette">
                                <th class="head_text">#</th>
                                <th class="head_text">Name</th>
                                <th class="head_text">Email</th>
                                <th class="head_text" width="35%">Content</th>
                        ...
                        <tbody>
                            ...
                            <tr>          
                                <td>{{ $i }}</td>                        
                                <td>{{ $testimonials_data->name }} </td>  
                                <td>{{ $testimonials_data->email }} </td>  
                                <td>{{ substr($testimonials_data->description, 0, 150) }} </td>  
                                <td><a class="btn btn-default" href="<?php echo url('admin/testimonials/edit/'.$testimonials_data->id); ?>" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn btn-default" href="<?php echo url('admin/testimonials/show/'.$testimonials_data->id); ?>" title="View"><i class="fa fa-file-text"></i></a></td>
                                <td><input name="chkall[]" id="chkall" class="chkall" type="checkbox" value="{{ $testimonials_data->id }}"></td>
                            </tr>
                            <?php $i++; ?>   
                            @endforeach
                            @else

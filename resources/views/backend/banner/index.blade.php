...
<div class="container spark-screen" style="width:100%;">
    ...
    @endif 
    <div class="row">
        <div class="col-md-8 col-md-offset-2"> <a class="btn btn-app" href="{{ url('admin/banner/add') }}" title="Add"> <i class="fa fa-plus"></i> Add </a>
            <a class="btn btn-app bg-green" href="{{ url('admin/banner') }}" title="Active"> <i class="fa fa-check-circle"></i>
                Active ({{ $active_count }}) </a>
            <a class="btn btn-app bg-red" href="{{ url('admin/banner/?token=inactive') }}" title="Inactive"> <i class="fa fa-ban"></i>
        ...
        <div class="col-xs-12">
            ...
            ?>">
                ...
                <div class="box-footer clearfix"> 
                    <form name="frm_action" id="frm_action" method="post" action="{{ url('/admin/banner/actionupdate') }}">
                        {{ csrf_field() }}
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <td>
                                    ...
                                    <img src="<?php echo url('uploads/banner_attachment/'.$banner_data->id); ?>/<?php echo $banner_data->image; ?>" style="width:200px; height:100px;">
                                    @else
                                    <img src="<?php echo url('images/no-image.png'); ?>" style="width:100px; height:90px;">
                                    @endif
                                </td>   
                                <td>{{ $banner_data->position }} </td>  
                                <td><a class="btn btn-default" href="<?php echo url('admin/banner/edit/'.$banner_data->id); ?>" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn btn-default" href="<?php echo url('admin/banner/show/'.$banner_data->id); ?>" title="View"><i class="fa fa-file-text"></i></a></td>

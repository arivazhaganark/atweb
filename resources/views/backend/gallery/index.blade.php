...
<div class="container spark-screen" style="width:100%;">
   ...
   @endif 
   <div class="row">
      <div class="col-md-8 col-md-offset-2"> <a class="btn btn-app" href="{{ url('admin/gallery/add') }}" title="Add"> <i class="fa fa-plus"></i> Add </a>
         <a class="btn btn-app bg-green" href="{{ url('admin/gallery') }}" title="Active"> <i class="fa fa-check-circle"></i>
         Active ({{ $active_count }}) </a>
         <a class="btn btn-app bg-red" href="{{ url('admin/gallery/?token=inactive') }}" title="Inactive"> <i class="fa fa-ban"></i>
      ...
      <div class="col-xs-12">
         <div class="box <?php
            ...
            <div class="box-footer clearfix">
               <form name="frm_action" id="frm_action" method="post" action="{{ url('/admin/gallery/actionupdate') }}">
                  {{ csrf_field() }}
            ...
            <div class="box-body">
               ...
               <tbody>
                  <?php $i = 1; ?>
                  @if ( $index->count() > 0 )
                  @foreach( $index as $gallery_data )
                  <tr>
                     <td>{{ $i }}</td>
                     <td>{{ $gallery_data->title }} </td>
                     <td><a class="btn btn-default" href="<?php echo url('admin/gallery/edit/'.$gallery_data->id); ?>" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn btn-default" href="<?php echo url('admin/gallery/show/'.$gallery_data->id); ?>" title="View"><i class="fa fa-file-text"></i></a></td>
                     <td><input name="chkall[]" id="chkall" class="chkall" type="checkbox" value="{{ $gallery_data->id }}"></td>
                  </tr>
                  <?php $i++; ?>   
                  @endforeach
                  @else

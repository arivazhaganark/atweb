...
<div class="container spark-screen" style="width:100%;">
   ...
   @endif 
    <div class="row">
        <div class="col-md-8 col-md-offset-2"><a class="btn btn-app bg-green" href="{{ url('admin/visitor') }}" title="Active"> <i class="fa fa-check-circle"></i> Active ({{ $active_count }}) </a> <a class="btn btn-app bg-red" href="{{ url('admin/visitor/?token=inactive') }}" title="Inactive"> <i class="fa fa-ban"></i> Inactive ({{ $inactive_count }}) </a></div>
        <div class="col-xs-12">
            <div class="box <?php
            ...
            ?>">
                <div class="box-header">
                    <h3 class="box-title">
                        ...
                        ?>"><?php
                        if (isset($_REQUEST['token']) && $_REQUEST['token'] != '') {
                            echo 'Inactive Visitor';
                        } else {
                            ?>Active Visitor<?php } ?></p>
                    </h3>
                </div>
                @if(count($user) > 0)
                <div class="box-footer clearfix"> 
                    <form name="frm_action" id="frm_action" method="post" action="{{ url('/admin/visitor/actionupdate') }}">
                        {{ csrf_field() }}
                    ...
                    <table @if(count($user)>0) id="example1" @else id="" @endif class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <td><a class="btn btn-default" href="<?php echo url('admin/visitor/edit/'.$row->id); ?>" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn btn-default" href="<?php echo url('admin/visitor/show/'.$row->id); ?>" title="View"><i class="fa fa-file-text"></i></a></td>
                                <td>
                            ...
                            @else
                            <tr>          
                                <td colspan="6">No visitor found</td>
                            </tr>   
                            @endif                    
                        </tbody>
                    </table>

                ...
                <div class="box-body">
                    <table @if($cms->count()>0) id="example1" @else id="" @endif class="table table-bordered table-striped">
                            ...
                            <tr class="bg-gray color-palette">
                                ...
                                <th class="head_text">Parent</th>
                                <th class="head_text">Category</th>
                                <th class="head_text">Column</th>
                                <th class="head_text">Title</th>
                                <th class="head_text">Page Type</th>
                        ...
                        <tbody>
                            ...
                            <tr>          
                                <td>{{ $i }}</td>
                                <td>{{ getParentName($cms_data->parent) }}</td>                        
                                <td>{{ getCategoryName($cms_data->cat_id) }} </td>  
                                <td>{{ $cms_data->columns }} </td>  
                                <td>{{ $cms_data->footer_title }} </td>  
                                <td>
                                    @if($cms_data->page_type=='link')
                                        column - {{ $cms_data->columns }}
                                    @else
                                        {{ $cms_data->page_type }}
                                    @endif
                                </td>   

                    ...
                    <table @if(count($user)>0) id="example1" @else id="" @endif class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <td><a class="btn btn-default" href="<?php echo url('admin/user/edit/'.$row->id); ?>" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn btn-default" href="<?php echo url('admin/user/show/'.$row->id); ?>" title="View"><i class="fa fa-file-text"></i></a></td>
                                <td>

                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <p>Hi {{ $name }},</p>
									<p>Thank you for registering for a Partner account. Your account creation is under process and pending approval. We shall send login credentials shortly to enable you to access Partner Resources & further engage with us. </p>
                                </td>
                            </tr>                            
                        </table>
                    </td>

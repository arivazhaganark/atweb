...
<?php
   $filemanager = App\Model\backend\FileManagerModel::where('parent_id', '=', 0)->first();
...
<script type="text/javascript">
   ...
   function fnTs(dir, file_id) {
       ...
       $.ajax({
           type: "POST",
           url: app_url + "/visitor/filemanager/ajaxfm",
   ...
   $('.back').click(function(){ 
      ...
      $.ajax({
           type: "POST",
           url: app_url + "/visitor/filemanager/parentinfo",
